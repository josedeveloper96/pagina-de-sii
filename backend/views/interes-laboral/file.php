...
<?php
$array=Estudiantes::getPersonalData(Yii::$app->session['nc']);
$array2=PerfilEgresado::getPersonalData(Yii::$app->session['nc']);
$array3=InfAcademica::getPersonalData(Yii::$app->session['nc']);
$array4=InformacionLaboral::getProfesionalData(Yii::$app->session['nc']);
$array5=RefProfesionales::getProfesionalData(Yii::$app->session['nc']);
