...
/**
 * repetitivasegresadosSearch represents the model behind the search form of `app\models\RepetitivasEgresados`.
 */
class repetitivasegresadosSearch extends RepetitivasEgresados
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = RepetitivasEgresados::find();
        ...
        $query->andFilterWhere(['like', 'rep_egr_cur_act', $this->rep_egr_cur_act])
            ...
            ->andFilterWhere(['like', 'rep_egr_no_de_control',Yii::$app->session['usuario']]);
