...
use common\models\PerfilEgresado2;

/**
 * PerfilEgresado2Search represents the model behind the search form of `common\models\PerfilEgresado2`.
 */
class PerfilEgresado2Search extends PerfilEgresado2
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['per_egr_calle', 'per_egr_no', 'per_egr_colonia', 'per_egr_tel_cel', 'per_egr_tel_casa', 'per_egr_email', 'per_egr_est_civil', 'per_egr_paq_com', 'per_egr_fecha', 'per_no_de_control'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'per_egr_calle', $this->per_egr_calle])
            ...
            ->andFilterWhere(['like', 'per_no_de_control', $this->per_no_de_control]);
