...
use yii\jui\DatePicker;// php composer.phar require --prefer-dist yiisoft/yii2-jui
...
use kartik\file\FileInput;//php composer.phar require kartik-v/yii2-widget-fileinput "*"
...
?>
    ...
    <div class="row">
      <?= $form->field($model, 'per_foto')->widget(FileInput::classname(), [
...
?>
   ...
   // $modelestad = new Estados();
    ...
    <?php //$form->field($model, 'per_egr_fecha')->hiddenInput(['value' =>  date('Y-m-d H:i:s A')])->label(false)?>
