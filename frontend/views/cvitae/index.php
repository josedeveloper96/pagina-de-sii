...
$infAcademica=false;
$infLaboral=false;
$infRefProfesionales=false;
?>
<h1>Curriculum vitae</h1>
    <p>
    <?= Html::tag('div','<h4>'.'Puede agregar más información personal y una fotografía aquí:</h4>'.'</h4>')?>
    <table id='botonera'>
<tr>
<td>
<?php
        $urlregemp =Yii::$app->request->baseUrl. '/index.php?r=perfil-egresado%2Fcreate'; 
        echo  Html::a('Perfil',$urlregemp, ['class' => 'btn btn-success']);
         ?>
        <?php
        $urlregemp =Yii::$app->request->baseUrl. '/index.php?r=informacion-laboral%2Fcreate'; 
        echo  Html::a('Información laboral',$urlregemp, ['class' => 'btn btn-success']);
         ?>
</td>
<td>
        <?php
        $urlregemp =Yii::$app->request->baseUrl. '/index.php?r=inf-academ%2Fcreate'; 
        echo  Html::a('Información académica',$urlregemp, ['class' => 'btn btn-success']);
         ?>
</td>
<td>
        <?php
        $urlregemp =Yii::$app->request->baseUrl. '/index.php?r=ref-profesionales%2Fcreate'; 
        echo  Html::a('Referencias profesionales',$urlregemp, ['class' => 'btn btn-success']);
         ?>
</td>
<td>
        <?php
        $urlregemp =Yii::$app->request->baseUrl. '/index.php?r=cvitae%2Fpdf'; 
        echo  Html::a('Imprimir pdf',$urlregemp, ['class' => 'btn btn-success','id' =>'pdfbutton']);
         ?>
</td>
<td>
...
//echo $array[0]['est_fecha_nacimiento'];
}else{
    echo  "<span ><h4>Nota: Necesita actualizar el Perfil para poder imprimir un Curriculum vitae</h4></span>";
