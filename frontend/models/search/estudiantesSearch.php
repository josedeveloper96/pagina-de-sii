...
class estudiantesSearch extends Estudiantes
{
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'est_periodo_revalidacion' => $this->est_periodo_revalidacion,
        ...
        $query->andFilterWhere(['like', 'est_no_de_control',Yii::$app->session['usuario']])
            ->andFilterWhere(['like', 'est_carrera', $this->est_carrera])
            ->andFilterWhere(['like', 'est_nive_escolar', $this->est_nive_escolar])
